				...
				<div id="send_drawer">
					...
					>
						<Form layout="vertical" hideRequiredMark>
								...
								<Col span={24} className="wid-100">
									<Form.Item label="">
										...
										{getFieldDecorator('text2', {
											rules: [{ required: true, message: 'Please enter' }],
										})(<Input placeholder="Please enter" className="input-box mar-top-15" />)}
									</Form.Item>
								</Col>
							</Row>
							<Row gutter={16}>
						 ...
						 <Row gutter={16} className="top-section">
								<Col span={11} className="width-95">
									<Form.Item label="" className="draw-formItem">
								...
								<Col span={11} className="draw-select width-95">
									<Form.Item label="and stations">
										{getFieldDecorator('stations', {
											rules: [{ required: true, message: 'Please select station' }],
										})(
									...
									{(() => {
										if (this.state.manualTabVisible) {
											return <div> 
												...
												<Button type="primary" icon="plus" onClick={this.showCreateTemplateDrawer}>New template</Button></div>
												<Card title="" bordered={false}>
													<Card.Grid className="grid-style">
														<Row type="flex" justify="space-between">
