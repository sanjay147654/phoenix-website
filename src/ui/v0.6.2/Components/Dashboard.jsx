...
import { Layout, Row, Col, Button, Select, Divider, Icon, Tabs, TreeSelect, Tooltip, Menu, DatePicker, notification, Spin } from 'antd';
							...
							<div className="contain">
								<Row className="rows" className="top-0">
									<Col className="city-select" span={10}>
										<TreeSelect treeDefaultExpandAll {...tProps} style={{ width: 500 }} />
									</Col>
								</Row>
								<Row className="rows" type="flex" justify="space-around">
									<Col className="cols map-container" span={16}>
											{/*<Button className="map-btn" type="primary" onClick={this.toggleClosed} style={{ marginBottom: 16 }}>
												<Icon type={this.state.closed ? 'menu-unfold' : 'menu-fold'} />
											</Button>
											 <Menu
												mode="inline"
												className="map-menu"
												theme="light"
												inlineCollapsed={this.state.closed}
											>
												<Menu.Item key="1">
													<span>Option 1</span>
												</Menu.Item>
										...
										<Row className="rows" id="label_container" type="flex" justify="start">
											<div className="label-wrapper">
												<div className="label-heading bold">
													Index:
												</div>
											...
											<div className="label-wrapper">
												...
												<div className="label-content">
													...
													<div className="rain-online-no-rain">
														No rainfall within last 24 hours
													</div>
									...
									{(() => {
										if (this.state.visible) {
											return <Col className="cols width-100 search" span={6}>
												...
												<div className="device-details">
													...
													<Row type="flex" justify="left" className="device-row">
														<Col span={14} offset={1} className="text-left">Open Canal-1</Col>
														<Col span={2} offset={2}><div className="warning-back dot"></div></Col>
														<Col span={1} offset={1}><span className="next-butn" onClick={() => this.openShow()}><Icon type="right" /></span></Col>
													</Row>
													<Row type="flex" justify="left" className="device-row">
														<Col span={14} offset={1} className="text-left">Gated Canal-1</Col>
														<Col span={2} offset={2}><div className="danger-back dot"></div></Col>
														<Col span={1} offset={1}><span className="next-butn" onClick={() => this.gatedShow()}><Icon type="right" /></span></Col>
													</Row>
													<Row type="flex" justify="left" className="device-row">
													...
													<Row type="flex" justify="left" className="device-row">
														<Col span={14} offset={1} className="text-left">Pumping Station-9</Col>
														<Col span={2} offset={2}><div className="success-back dot"></div></Col>
														<Col span={1} offset={1}><span className="next-butn" onClick={() => this.pumpShow()}><Icon type="right" /></span></Col>
													</Row>
													<Row type="flex" justify="left" className="device-row">
														<Col span={14} offset={1} className="text-left">Pumping Station-10</Col>
														<Col span={2} offset={2}><div className="success-back dot"></div></Col>
														<Col span={1} offset={1}><span className="next-butn" onClick={() => this.pumpShow()}><Icon type="right" /></span></Col>
													</Row>
												</div>
											...
											return <Col className="cols width-100 back-grey" span={6}>
												<Row className="border-bot wid-90">
												...
												<div className="mar-top-10 time">
													<Tooltip title="Last data received Time">
														<span><img src="http://127.0.0.1:8080/clock_green.png" className="clock-img"/></span>
														16:49, 03 Sep 2018
													</Tooltip>
												</div>
												...
												<Row className="status-contain no-border">
													...
													<Row className="pump-names" type="flex" justify="space-around">
														<Col span={10} offset={2}>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-1 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-2 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-3 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col span={14} className="success text-left">Pump-4 :</Col>
																<Col className="success" span={5} offset={2}>On</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-5 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-6 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-7 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-8 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-9 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-10 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-11 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-12 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-14 :</Col>
																<Col span={5} offset={2}>Off</Col>
															</Row>
															<Row type="flex" justify="left" className="pumps">
																<Col className="text-left" span={14}>Pump-14 :</Col>
													 ...
													 <Button type="primary" className="more" onClick={() => this.openNotification('error')}>More Details</Button>
												</Row>
											</Col>;
										}
											...
											return <Col className="cols width-100 back-grey" span={6}>
												...
												<Row className="status-contain">
													<div className="status-hed">
														<img src="http://127.0.0.1:8080/rain.svg" className="status-img"/>
														Rainfall
													</div>
													<Row type="flex" justify="space-around">
														<Col span={10}>
										...
										else if(this.state.openVisible) {
											return <Col className="cols width-100 back-grey" span={6}>
												<Row className="border-bot wid-90">
													<Col className="hed" span={17}>Open Canal-1</Col>
													<Col className="close" span={2}><span className="close-butn" onClick={() => this.showList()}><Icon type="close" /></span></Col>
												</Row>
												<div className="mar-top-10 time">
													<Tooltip title="Last data received Time">
										...
										else if(this.state.gatedVisible) {
											return <Col className="cols width-100 back-grey" span={6}>
												<Row className="border-bot wid-90">
													<Col className="hed" span={17}>Gated Canal-1</Col>
													<Col className="close" span={2}><span className="close-butn" onClick={() => this.showList()}><Icon type="close" /></span></Col>
												</Row>
												<div className="mar-top-10 time">
													<Tooltip title="Last data received Time">
												...
												<Row className="status-contain mar-top-35">
													<Row type="flex" justify="space-around" align="middle">
														<Col span={10}>
															<img src="http://127.0.0.1:8080/street.svg" className="gated-img"/>
														</Col>
														<Col span={9}>
															...
															<Row type="flex" justify="middle" className="mar-top-11">
																<Col span={24}>
																	<div className="status-value">240 mm</div>
											...
											return <Col className="cols width-100 back-grey airQuality" span={6}>
												...
												<Row className="status-contain">
													<div className="status-hed">
														...
														<span className="symbol"><span className="bold">32</span><span> °C</span></span>
													</div>
													<div className="status-hed">
														<img src="http://127.0.0.1:8080/humid.svg" className="status-img"/>
														<span className="air-head">Humidity</span>
														<span className="symbol"><span className="bold">23</span><span> %</span></span>
													</div>
												</Row>
												<Row className="status-contain no-border">
													...
													<Row type="flex" justify="space-around">
														<Col className="text-left mar-left-26" span={10}>PM <sub>1</sub></Col>
														<Col className="text-left" span={10}>32 °C</Col>
													</Row>
													<Row type="flex" justify="space-around">
														<Col className="text-left mar-left-26" span={10}>PM <sub>2.5</sub></Col>
														<Col className="text-left" span={10}>32 °C</Col>
													</Row>
													<Row type="flex" justify="space-around">
														<Col className="text-left mar-left-26" span={10}>PM <sub>10</sub></Col>
														<Col className="text-left" span={10}>32 °C</Col>
													</Row>
												</Row>
											</Col>;
												...
												<Col className="back-transparant">
													<Row className="white">
														<Row className="pump-graph no-border">
															<Col span={24}>
																<div className="center bold">PM<sub>2.5</sub></div>
																<ReactHighcharts config={live_graph4} ref="chart"></ReactHighcharts>
															</Col>
														</Row>
														<Row type="flex" justify="center" className="center pad-bot">
															<Col span={5}>
																...
																<div>
																	<span className="graph-avg-value">35</span>µg/m<sup>3</sup>
																</div>
															</Col>
															...
															<Col span={5}>
																...
																<div>
																	<span className="graph-avg-value">15</span>µg/m<sup>3</sup>
																</div>
																<div>12:51, 02 sep</div>
															</Col>
															...
															<Col span={5}>
																...
																<div>18:45, 02 sep</div>
															</Col>
														</Row>
													</Row>
													<Row className="white mar-top-35">
														<Row className="pump-graph no-border">
															<Col span={24}>
																<div className="center bold">PM<sub>2.5</sub></div>
																<ReactHighcharts config={live_graph4} ref="chart"></ReactHighcharts>
												...
												<Col className="back-transparant">
													...
													<Row className="white">
														...
														<Row className="pump-graph">
															<Col className="pad-top-25" span={3}>
																<div>Pump-1</div>
																<div className="success">ON</div>
															</Col>
															<Col span={20}>
