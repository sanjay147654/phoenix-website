								...
								<Row className="mar-top-45">
									...
									<Row type="flex" justify="space-between">
										<Card title="Live Weather" bordered={false}>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://satellite.imd.gov.in/imc/3Dasiasec_ir1.jpg")}>
										    	<div className="card-head">Infra Red</div>
										    	<div className="card-body">
													<img  src="http://satellite.imd.gov.in/imc/3Dasiasec_ir1.jpg" className="live-img"/>
												</div>	
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://tropic.ssec.wisc.edu/real-time/indian/images/xxirm5bbm.jpg")}>
										    ...
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://tropic.ssec.wisc.edu/real-time/indian/images/irnm5.GIF")}>
										    ...
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://satellite.imd.gov.in/img/3Dasiasec_bt1.jpg")}>
										    	<div className="card-head">Heat Map</div>
										    	<div className="card-body">
													<img src="http://satellite.imd.gov.in/img/3Dasiasec_bt1.jpg" className="live-img"/>
												</div>
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://www.monsoondata.org/wx2/india4.00hr.png")}>
										    	<div className="card-head">Wind Direction</div>
										    	<div className="card-body">
													<img src="http://www.monsoondata.org/wx2/india4.00hr.png"className="live-img"/>
												</div>
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://www.monsoondata.org/wx2/ezindia4_day1.png")}>
								...
								<Row className="mar-top-45 mar-bot-35">
									...
									<Row type="flex" justify="space-between">
										<Card title="Rainfall Forecast" bordered={false}>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://satellite.imd.gov.in/img/3Dhalfhr_qpe.jpg")}>
										    	<div className="card-head">3 Hour</div>
										    	<div className="card-body">
													<img  src="http://satellite.imd.gov.in/img/3Dhalfhr_qpe.jpg" className="live-img"/>
												</div>	
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://nwp.imd.gov.in/gfs/24hGFS1534rain.gif")}>
										    	<div className="card-head">Tomorrow</div>
										    	<div className="card-body">
													<img src="http://nwp.imd.gov.in/gfs/24hGFS1534rain.gif" className="live-img"/>
												</div>
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://nwp.imd.gov.in/gfs/48hGFS1534rain.gif")}>
										    	<div className="card-head">Day 2</div>
										    	<div className="card-body">
													<img src="http://nwp.imd.gov.in/gfs/48hGFS1534rain.gif" className="live-img"/>
												</div>
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://nwp.imd.gov.in/gfs/72hGFS1534rain.gif")}>
										    	<div className="card-head">Day 3</div>
										    	<div className="card-body">
													<img src="http://nwp.imd.gov.in/gfs/72hGFS1534rain.gif" className="live-img"/>
												</div>
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://nwp.imd.gov.in/gfs/96hGFS1534rain.gif")}>
										    	<div className="card-head">Day 4</div>
										    	<div className="card-body">
													<img src="http://nwp.imd.gov.in/gfs/96hGFS1534rain.gif"className="live-img"/>
												</div>
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://nwp.imd.gov.in/gfs/120hGFS1534rain.gif")}>
										    	<div className="card-head">Day 5</div>
										    	<div className="card-body">
													<img src="http://nwp.imd.gov.in/gfs/120hGFS1534rain.gif" className="live-img"/>
												</div>
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://nwp.imd.gov.in/gfs/144hGFS1534rain.gif")}>
										    	<div className="card-head">Day 6</div>
										    	<div className="card-body">
													<img src="http://nwp.imd.gov.in/gfs/144hGFS1534rain.gif" className="live-img"/>
												</div>
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://nwp.imd.gov.in/gfs/168hGFS1534rain.gif")}>
										    	<div className="card-head">Day 7</div>
										    	<div className="card-body">
													<img src="http://nwp.imd.gov.in/gfs/168hGFS1534rain.gif" className="live-img"/>
												</div>
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://nwp.imd.gov.in/gfs/192hGFS1534rain.gif")}>
										    ...
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://nwp.imd.gov.in/gfs/240hGFS1534rain.gif")}>
										    	<div className="card-head">Day 10</div>
										    	<div className="card-body">
													<img src="http://nwp.imd.gov.in/gfs/240hGFS1534rain.gif" className="live-img"/>
												</div>
										    </Card.Grid>
										    <Card.Grid className="grid-style" onClick={() => this.showModal("http://www.monsoondata.org/wx2/kolkgfs.png")}>
