				...
				<div className="loading">
					<div className="top">
						<div className="left-load">
							<span className="animate back"></span>
							<span className="animate back"></span>
							<span className="animate back"></span>
							<span className="animate back"></span>
							<span className="animate text-load"></span>
						</div>
						<div className="right-load">
							<span className="animate logo-load"></span>
							<span className="animate logo-text-load"></span>
							<span className="animate logo-load"></span>
							<span className="animate logo-text-load"></span>
						</div>
					</div>
					...
					<div className="body-load">
						<div className="map-load">
							<Spin indicator={antIcon} className="spin-load" />
						</div>
									...
									{(() => {
										if (this.state.visible) {
											...
											return <Col className="cols width-100 back-grey" span={6}>
												...
												<Tooltip title="Last data received Time">
													<div className="center mar-top-10">
														<span><img src="http://127.0.0.1:8080/clock_red.png" className="clock-img"/></span>
														16:49:19, 03 Sep 2018
													</div>
												</Tooltip>
												<Row className="status-contain">
											...
											<Row className="back-transparant">
												<Col className="back-transparant">
													...
													<Row className="white mar-top-35">
														<Row className="pump-graph no-border">
															<Col span={18}>
																<div className="center bold">PM<sub>10</sub></div>
																<ReactHighcharts config={live_graph4} ref="chart"></ReactHighcharts>
															</Col>
															<Col span={5} offset={1}>
																<Row type="flex" justify="center" className="border-bot center">
